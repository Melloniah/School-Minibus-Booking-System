<div className="py-12 px-4 md:px-16 bg-gray-50">
  <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
    🚀 What Makes SafeRide Special
  </h2>

  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    {/* Card 1 */}
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
      <h3 className="text-xl font-semibold mb-2">🛡️ Safety First</h3>
    ...
    {/* Card 2 */}
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
      <h3 className="text-xl font-semibold mb-2">🗺️ Smart Routing</h3>
      <p className="text-gray-600">
    ...
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
      ...
      <p className="text-gray-600">
        Building connections between families while providing reliable transportation solutions.
      </p>
    </div>
