  ...
  return (
    <div className="max-w-[90%] mx-auto my-20 flex flex-col md:flex-row justify-between gap-10">
      ...
      <div className="flex-1 text-gray-600">
        <h3 className="text-grey-800 text-2xl font-medium mb-4">
          Send us a message
        </h3>
      ...
      <div className="flex-1">
        <form onSubmit={onSubmit} className="bg-white rounded-md p-4">
          ...
          <input
            ...
            required
            className="w-full bg-[#fcd6e2] p-3 mb-4 border-none outline-none rounded"
          />
          ...
          <textarea
            ...
            required
            className="w-full bg-[#fcd6e2] p-3 mb-4 border-none outline-none resize-none rounded"
          ></textarea>
